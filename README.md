...
Designed primarily for portrait mobile phone (iPhone XS and Galaxy A3 as references), but also works on desktop. On desktop, use (`shift`-) `tab`, `space`, `esc` and `arrow` keys for easier navigation while playing an instrument.
